...
def index():
    ...
    <head>
        ...
        <style>
            ...
            .img-link { display: block; text-decoration: none; border-bottom: none; outline: none; }
            .img-link:hover img, .img-link:focus-visible img { filter: brightness(1) contrast(1); box-shadow: 0 4px 6px var(--img-shadow); border-color: var(--link-focus-outline); }
            .img-link:focus-visible { outline: 3px solid var(--link-focus-outline); outline-offset: 4px; border-radius: 4px; }
    ...
    <body>
        ...
        <main id="main" tabindex="-1">
            ...
            <figure>
                <a href="/assets/lid_driven_streamlines.png" target="_blank" rel="noopener noreferrer" class="img-link" aria-label="Open Lid Driven Cavity Streamlines plot in a new tab">
            ...
            <figure>
                <a href="/assets/grid_convergence.png" target="_blank" rel="noopener noreferrer" class="img-link" aria-label="Open Grid Convergence Study plot in a new tab">
            ...
            <figure>
                <a href="/assets/scheme_comparison.png" target="_blank" rel="noopener noreferrer" class="img-link" aria-label="Open Convection Scheme Comparison plot in a new tab">
