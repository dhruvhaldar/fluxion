...
class LinearSolver:
    ...
    def solve_jacobi(p, rhs, grid, max_iter=5000, tol=1e-5):
        ...
        for it in range(max_iter):
            ...
            # Using augmented assignments minimizes Python wrapper function call overhead compared to sequential np.add.
    ...
    def solve_sor(p, rhs, grid, omega=1.7, max_iter=5000, tol=1e-5):
        ...
        for it in range(max_iter):
            ...
            # and use augmented assignments to minimize Python wrapper function call overhead.
